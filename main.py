...
if __name__ == '__main__':
    ...
    for _, koGeneData in src.iterrows():
        ...
        plt.savefig(f'Plots/{koGenes[koGeneKey]["TT_Type"]}/{koGeneKey} KO.png', dpi=200, format='png',
                    bbox_inches='tight')
        plt.close()
        ...
        results.append(
            {
                ...
                "Nervous": koGenes[koGeneKey]["nervous"]["avg"],
                "Not Nervous": koGenes[koGeneKey]["notNervous"]["avg"],
...
file_name = f"{date} Neurons Viability Score Results.csv"
